...
about: Propose a new feature for the rhosocial-activerecord Snowflake backend, targeting a pre-release branch (e.g., release/vX.Y.Z).
...
- [ ] `chore`: Changes to the build process or auxiliary tools and libraries such as documentation generation (if related to the new feature)
...
Also, list any relevant configuration details (e.g., Snowflake connector version, Python version).
-->
