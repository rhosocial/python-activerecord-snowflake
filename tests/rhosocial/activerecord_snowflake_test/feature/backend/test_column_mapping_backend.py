# tests/rhosocial/activerecord_snowflake_test/feature/backend/test_column_mapping_backend.py
import pytest
...
@pytest.fixture
def setup_mapped_users_table(snowflake_backend):
    """Fixture to create and drop a 'mapped_users' table for MySQL."""
    snowflake_backend.execute("DROP TABLE IF EXISTS mapped_users")
...
def test_insert_with_mapping(snowflake_backend, setup_mapped_users_table):
    """
...
def test_update_with_backend(snowflake_backend, setup_mapped_users_table):
    """
...
def test_fetch_with_combined_mapping_and_adapters(snowflake_backend, setup_mapped_users_table):
    """
