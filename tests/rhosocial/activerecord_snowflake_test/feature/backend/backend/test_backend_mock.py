# tests/rhosocial/activerecord_snowflake_test/feature/backend/backend/test_backend_mock.py
...
class TestSnowflakeBackendErrorClassification:
    ...
    def test_classify_snowflake_gateway_timeout(self):
        try:
            ...
            pytest.skip("GatewayTimeoutError not available in this connector version")
    ...
    def test_classify_snowflake_request_timeout(self):
        try:
            ...
            pytest.skip("RequestTimeoutError not available in this connector version")
    ...
    def test_classify_snowflake_service_unavailable(self):
        try:
            ...
            pytest.skip("ServiceUnavailableError not available in this connector version")
    ...
    def test_classify_snowflake_http_error(self):
        try:
            ...
            pytest.skip("HttpError not available in this connector version")
