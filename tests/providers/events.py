"""Events test provider for Snowflake backend.

Implements IEventsProvider for event feature tests using
...
class EventsProvider(IEventsProvider):
    ...
    def _load_snowflake_schema(self, filename: str) -> str:
        schema_dir = os.path.join(os.path.dirname(__file__), "..", "rhosocial", "activerecord_snowflake_test", "feature", "events", "schema")
