...
Implements IMixinsProvider for mixin feature tests using
...
class MixinsProvider(IMixinsSyncProvider):
    ...
    def _load_snowflake_schema(self, filename: str) -> str:
        schema_dir = os.path.join(os.path.dirname(__file__), "..", "rhosocial", "activerecord_snowflake_test", "feature", "mixins", "schema")
